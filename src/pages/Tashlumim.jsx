  ...
  return (
    <Tooltip title={copied ? 'הועתק!' : 'העתק'} placement="top">
      <IconButton size="small" onClick={copy}
        sx={{ color: copied ? '#4ade80' : 'primary.main', p: 0.4, transition: 'color 0.2s' }}>
  ...
  return (
    <Box>
      ...
      <Box sx={{ py: 7 }}>
        <Container maxWidth="lg">
          ...
          <Grid container spacing={3}>
            ...
            {/* BIT */}
            <Grid item xs={12} sm={6} md={4} lg id="bit">
              <Card sx={{ height: '100%' }}>
                <CardContent sx={{ display: 'flex', flexDirection: 'column', gap: 1.5, height: '100%' }}>
                  ...
                  <PhoneBox label="מספר לביט:" value={BIT_PHONE} />
                  <Button href={BIT_LINK} target="_blank" rel="noopener" variant="outlined"
                    sx={{ mt: 'auto', borderColor: '#0091FF', color: '#0091FF', fontWeight: 700, '&:hover': { borderColor: '#0091FF', bgcolor: 'rgba(0,145,255,0.08)' } }}>
                    פתח ביט
                  </Button>
                </CardContent>
              </Card>
            ...
            {/* PAYBOX */}
            <Grid item xs={12} sm={6} md={4} lg id="paybox">
              <Card sx={{ height: '100%' }}>
                <CardContent sx={{ display: 'flex', flexDirection: 'column', gap: 1.5, height: '100%' }}>
                  <Box sx={{ height: 32 }} />
                  ...
                  <PhoneBox label="מספר לפייבוקס:" value={PAYBOX_PHONE} />
                  <Button href={PAYBOX_LINK} target="_blank" rel="noopener" variant="outlined"
                    sx={{ mt: 'auto', borderColor: '#6c3cbf', color: '#6c3cbf', fontWeight: 700, '&:hover': { borderColor: '#6c3cbf', bgcolor: 'rgba(108,60,191,0.08)' } }}>
                    פתח פייבוקס
                  </Button>
                </CardContent>
              </Card>
            ...
            {/* NEDARIM PLUS */}
            <Grid item xs={12} sm={6} md={4} lg id="nedarimplus">
              <Card sx={{ height: '100%' }}>
                <CardContent sx={{ display: 'flex', flexDirection: 'column', gap: 1.5, height: '100%' }}>
                  <Box sx={{ height: 32 }} />
                  ...
                  <Button href={NEDARIM_LINK} target="_blank" rel="noopener" variant="outlined"
                    sx={{ mt: 'auto', borderColor: '#1a56b0', color: '#4a90d9', fontWeight: 700, '&:hover': { borderColor: '#1a56b0', bgcolor: 'rgba(26,86,176,0.08)' } }}>
                    תשלום בנדרים פלוס
                  </Button>
                </CardContent>
              </Card>
            ...
            {/* CREDIT CARD */}
            <Grid item xs={12} sm={6} md={4} lg id="credit">
              <Card sx={{ height: '100%' }}>
                <CardContent sx={{ display: 'flex', flexDirection: 'column', gap: 1.5, height: '100%' }}>
                  <Box sx={{ height: 32 }} />
                  ...
                  <Typography variant="body2" color="text.secondary">
                    תשלום מאובטח בכרטיס אשראי — קבלה תישלח למייל באופן מידי
                  </Typography>
                  <Box sx={{ bgcolor: 'rgba(0,0,0,0.2)', borderRadius: 1, p: 1.5 }}>
                  ...
                  <Button
                    ...
                    sx={{
                      ...
                      color: 'primary.main',
                      fontWeight: 700,
                      '&:hover': { borderColor: 'primary.main', bgcolor: 'rgba(201,168,76,0.08)' },
                    }}
                  >
                    שלם באשראי
                  </Button>
            ...
            {/* BANK */}
            <Grid item xs={12} sm={6} md={4} lg id="bank">
              <Card sx={{ height: '100%' }}>
                <CardContent sx={{ display: 'flex', flexDirection: 'column', gap: 1.5, height: '100%' }}>
                  <Box sx={{ height: 32 }} />
                    ...
                    <TableBody>
                      {BANK_ROWS.map(([k, v]) => (
                        <TableRow key={k}>
                          ...
                          <TableCell sx={{ border: 'none', py: 0.5, px: 0.5, width: 32 }}>
                            <CopyButton value={v} />
                          </TableCell>
                        </TableRow>
                      ))}
            ...
            {/* STANDING ORDER */}
            <Grid item xs={12} sm={6} md={4} lg id="horaatkeva">
              <Card sx={{ height: '100%' }}>
                <CardContent sx={{ display: 'flex', flexDirection: 'column', gap: 1.5, height: '100%' }}>
                  <Box sx={{ height: 32 }} />
          ...
          <Card sx={{ mt: 6, p: 3, textAlign: 'center', bgcolor: 'rgba(201,168,76,0.07)', borderColor: 'primary.main' }}>
            ...
            <Button component={Link} to="/cheshbon" variant="contained" size="large">לחשבון האישי שלי</Button>
          </Card>
      ...
      <CreditCardDialog
        ...
        amount={0}
        description="תשלום לבית כנסת אדרת אליהו"
      />
    </Box>
  );
}
