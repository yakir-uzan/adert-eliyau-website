        ...
        <Grid container spacing={4} sx={{ pb: 4 }}>
          <Grid item xs={12} sm={4}>
            ...
            <Typography variant="body2" color="text.secondary" sx={{ lineHeight: 2 }}>
              ...
              {config.address}<br />
              <MuiLink href={config.phoneHref} color="inherit">{config.phone}</MuiLink>
            </Typography>
          </Grid>
          <Grid item xs={12} sm={4}>
            ...
            {[
              ...
              <Typography key={l.to} variant="body2">
                <MuiLink component={Link} to={l.to} color="text.secondary" underline="hover"
                  sx={{ lineHeight: 2.2, display: 'block', '&:hover': { color: 'primary.light' } }}>
                  {l.label}
                </MuiLink>
              </Typography>
            ))}
          ...
          <Grid item xs={12} sm={4}>
            ...
            <Typography variant="body2" color="text.secondary" sx={{ lineHeight: 2.2 }}>
              ...
              <MuiLink href={`mailto:${config.email}`} color="inherit" underline="hover">{config.email}</MuiLink>
            </Typography>
            <Button
              ...
              sx={{ mt: 1.5, bgcolor: '#25D366', color: '#fff', fontWeight: 700, fontSize: '0.88rem', px: 2, '&:hover': { bgcolor: '#1ebe5d' } }}
            >
              קבוצת וואטסאפ
            </Button>
          </Grid>
